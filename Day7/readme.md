...
3. The output will show the total calibration result from the input data.

Notes:

- A photo of my handwritten notes is attached at the end to show my thinking process.
